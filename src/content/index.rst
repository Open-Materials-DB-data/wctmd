...
An archive with the data related to this work is available here: `W_C_all_files.tar.gz <https://pw91.openmaterialsdb.se/data/WC_tetragonal_Materials_and_Design/W_C_all_files.tar.gz>`__
